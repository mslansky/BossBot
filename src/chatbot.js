...
const HintBotPrompts = {
  ...
  about compensation. This is often the hardest part of the conversation, as many people, including you, may have never 
  done this. First, remember to be direct! It's normal and reasonable to ask for a raise.`,
  ...
  "OtherTopics": `*Hintbot Here!* Other topics you may want to consider discussing is if any new responsibilities will be required.
  Some companies may require management duties at certain pay grades.`,
  ...
  and understand what your local market rate is. Additionally, your company may have other conditions such as job code 
  that affect salary`,
...
const BossBotPrompts = {
  ...
  "Salary": "Okay, thanks for being specific. That makes my job easier. Ultimately, these changes are up to HR, but you've given me the right info to take the next steps",
  "Finish": null
};
